...
- (void)sendRewardPrePayRequestWithAmount:(int)arg1 comment:(id)arg2 isSelectAmount:(BOOL)arg3;
...
- (void)onEditMoneyViewControllerConfirmRewardWithAmount:(int)arg1 comment:(id)arg2;
