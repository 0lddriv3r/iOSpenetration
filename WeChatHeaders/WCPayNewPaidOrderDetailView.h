...
@class CShakeChecker, MMUILabel, NSMutableArray, NSString, UIBezierPath, UIButton, UIImageView, UILabel, UIScrollView, WCPayControlData, WCPayImageMaskView, WCPayLotteryView, WCPayWebImageView;

@interface WCPayNewPaidOrderDetailView : MMUIView <WCPayImageMaskViewFilledDelegate, ShakeCheckerDelegate, WCPayLotteryViewDelegate>
{
    BOOL _isShaking;
    BOOL _bCanShake;
...
@property(retain, nonatomic) MMUIView *discountView; // @synthesize discountView=_discountView;
