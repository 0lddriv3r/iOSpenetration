...
- (void)startRecord:(id)arg1 sampleRate:(unsigned int)arg2 encodeBitRate:(unsigned int)arg3 channels:(unsigned int)arg4 duaration:(float)arg5 frameByteSize:(unsigned int)arg6;
