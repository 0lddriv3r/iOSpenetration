...
@class CContact, CheckHoneyPayerResp, CheckHoneyUserResp, CreateHoneyPayCardResp, GetCreateTokenSignResp, GetHoneyPayCardResp, GetMCreditLineTokenSignResp, HoneyPayListResp, HoneyPayListResp_HoneyPayRecord, NSString, QryHoneyPayCardDetailResp, QryHoneyPayerDetailResp, QryHoneyUserDetailResp, WCPayBindCardInfo;
