...
@class AVPlayerItemVideoOutput, HttpVideoStreamPlayerView, MMProgressViewEx, MMUILabel, MPVolumeView, NSString, UIButton, UIImage, UIImageView, WAScreenBrightnessStateView, WCNetworkMediaSlider, WSPlayerMaskView, WSPlayerSimpleProgressBar, WSVideoModel;
