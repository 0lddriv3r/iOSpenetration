...
- (void)workthread_writeFileDataWithAppID:(id)arg1 localID:(id)arg2 isUpdate:(BOOL)arg3 fromPosition:(unsigned int)arg4 data:(id)arg5 handler:(CDUnknownBlockType)arg6;
...
- (void)writeFileDataWithAppID:(id)arg1 localID:(id)arg2 isUpdate:(BOOL)arg3 fromPosition:(unsigned int)arg4 data:(id)arg5 handler:(CDUnknownBlockType)arg6;
