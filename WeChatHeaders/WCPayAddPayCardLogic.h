...
@class JSEvent, NSString, WCBaseControlLogic, WCPayBindCardSuccessResponse, WCPayGetPayUserDutyCgi, WCPaySetUserExInfoCgi, WCRedEnvelopesControlData;

@interface WCPayAddPayCardLogic : WCPayControlLogic <WCPayPrivacyViewControllerDelegate, WCPayGetPayUserDutyCgiDelegate, WCPayFillCardInfoViewControllerDelegate, WCPayFillCardNumberViewControllerDelegate, WCPayPayPwdViewControllerDelegate, WCPayVerifyPayCardViewControllerDelegate, WCPayTenpayImportCardInfoViewControllerDelegate>
{
