...
- (void)offlinePayAckMsg:(id)arg1 ReqKey:(id)arg2 PayMsgType:(int)arg3 TransId:(id)arg4 Processed:(BOOL)arg5 IsPosEnabled:(BOOL)arg6 IsMsgFromPull:(BOOL)arg7;
- (void)offlineCancelPay:(id)arg1 PayChannel:(unsigned long)arg2 completion:(CDUnknownBlockType)arg3;
...
- (id)startSelectSingleContactLogic:(id)arg1 withControlData:(id)arg2 delegate:(id)arg3 onlyShowContactList:(BOOL)arg4 pushVC:(BOOL)arg5;
