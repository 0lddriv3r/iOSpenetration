...
@class MMTimer, NSMutableDictionary, NSString, WAAppTask, WARemoteDebugChannel, WARemoteDebugRecvQueue, WARemoteDebugSendQueue, WARemoteDebug_BaseReq, WCStateMachine;
...
- (void)remoteSetupContextWithConfigureJS:(id)arg1 publibVersion:(unsigned long)arg2 publibMD5:(id)arg3 threeJSMD5:(id)arg4;
...
- (void)beginDebugWithRoomID:(id)arg1 pkgInfo:(id)arg2 channelType:(unsigned long)arg3 proxyPort:(unsigned long)arg4;
