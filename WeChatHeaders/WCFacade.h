...
- (BOOL)shouldShowSnsRecentSettingGuide;
...
- (void)tryLogClickBigImage:(id)arg1 clickIndex:(unsigned long)arg2 clickCount:(unsigned long)arg3 downloadCount:(unsigned long)arg4 scanIndexArrayStr:(id)arg5 scaleOutIndexArrayStr:(id)arg6 scaleInIndexArrayStr:(id)arg7;
