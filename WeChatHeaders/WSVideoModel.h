...
@property(nonatomic) unsigned long playEndTime; // @synthesize playEndTime=_playEndTime;
@property(nonatomic) unsigned long playStartTime; // @synthesize playStartTime=_playStartTime;
