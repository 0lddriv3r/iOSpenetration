...
@class DrawLotteryResponse, ExposureInfoModifyResponse, GetLotteryResponse, MMWebViewController, NSMutableArray, NSString, WCPayDrawLotteryCgi, WCPayGetLotteryCgi, WCPayModifyExposureCgi, WCPayOfflineGetMsgCgi, WCPayOfflinePayConfirmView, WCPayPayMoneyLogic, WCPayRealnameGuideInfo;

@interface WCPayOfflinePayMainLogic : WCPayControlLogic <UIViewControllerTransitioningDelegate, MMWebViewDelegate, WCPayAddPayCardDelegate, WCPayGPWalletLaunchControlLogicDelegate, WCPayOpenECardControlLogicExt, WCPayT2BCTransferControlLogicDelegate, WCPayDrawLotteryCgiDelegate, WCPayGetLotteryCgiDelegate, WCPayModifyExposureCgiDelegate, WAAppTaskMgrExt, WCPayOfflinePayViewControllerDelegate, WCPayOrderDetailHistoryViewControllerDelegate, WCBaseControlMgrExt, WCPayOfflinePayConfirmViewDelegate, WCPayPaidOrderDetailViewControllerDelegate, WCPayOfflineGetMsgCgiDelegate>
{
    int m_uiLocationTag;
